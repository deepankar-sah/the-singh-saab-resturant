...
description: "Complete design system for The Singh Saab, a fine-dining multi-cuisine restaurant in Mango, Jamshedpur. Identity built around the iconic Sikh turban + beard silhouette mark, rendered in warm gold on black. Covers colors, typography, layout, components, and motion for web, menu, and marketing collateral. Premium, masculine, regal — 'every texture chosen with intent, every detail built with soul'."
colors:
  primary: "#D4AF37"
  secondary: "#0A0A0A"
  tertiary: "#B8860B"
